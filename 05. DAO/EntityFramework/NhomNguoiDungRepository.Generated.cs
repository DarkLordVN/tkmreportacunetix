...
{   
	public partial class NhomNguoiDungRepository
	{
		private IRepository<NhomNguoiDung> _repository {get;set;}
		public IRepository<NhomNguoiDung> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public NhomNguoiDungRepository(IRepository<NhomNguoiDung> repository, IUnitOfWork unitOfWork)
    	{
    		Repository = repository;
			Repository.UnitOfWork = new EFUnitOfWork(); 
    	}

		public List<NhomNguoiDung> GetList(Expression<Func<NhomNguoiDung, bool>> where)
        {
            try
            {
                IEnumerable<NhomNguoiDung> lResult;
                if (where != null)
                {
		...
		public List<NhomNguoiDung> GetList(Expression<Func<NhomNguoiDung, bool>> where, int pageIndex, int pageSize, ref int totalItem, Func<NhomNguoiDung, object> orderCol = null, bool isDecending = true)
        {
            try
            {
                IEnumerable<NhomNguoiDung> lResult;
        ...
        public NhomNguoiDung GetByFilter(Expression<Func<NhomNguoiDung, bool>> where)
        {
            try
            {
                Repository.Save();
		...
		public bool CheckByFilter(Expression<Func<NhomNguoiDung, bool>> where)
        {
            try
            {
                Repository.Save();
        ...
        public bool Add(NhomNguoiDung entity)
        {
		...
		public bool Add(List<NhomNguoiDung> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
        ...
        public bool Update(NhomNguoiDung entity)
        {
            try
            {
		...
		public bool Update(List<NhomNguoiDung> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
