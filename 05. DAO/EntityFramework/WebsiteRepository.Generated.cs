...
{   
	public partial class WebsiteRepository
	{
		private IRepository<Website> _repository {get;set;}
		public IRepository<Website> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public WebsiteRepository(IRepository<Website> repository, IUnitOfWork unitOfWork)
    	{
    		Repository = repository;
			Repository.UnitOfWork = new EFUnitOfWork(); 
    	}

		public List<Website> GetList(Expression<Func<Website, bool>> where)
        {
            try
            {
                IEnumerable<Website> lResult;
                if (where != null)
                {
		...
		public List<Website> GetList(Expression<Func<Website, bool>> where, int pageIndex, int pageSize, ref int totalItem, Func<Website, object> orderCol = null, bool isDecending = true)
        {
            try
            {
                IEnumerable<Website> lResult;
        ...
        public Website GetByFilter(Expression<Func<Website, bool>> where)
        {
            try
            {
                Repository.Save();
		...
		public bool CheckByFilter(Expression<Func<Website, bool>> where)
        {
            try
            {
                Repository.Save();
        ...
        public bool Add(Website entity)
        {
		...
		public bool Add(List<Website> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
        ...
        public bool Update(Website entity)
        {
            try
            {
		...
		public bool Update(List<Website> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
