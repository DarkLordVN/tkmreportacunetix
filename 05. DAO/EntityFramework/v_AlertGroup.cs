...
namespace TKM.DAO.EntityFramework
{
    ...
    public partial class v_AlertGroup
    {
        ...
        public Nullable<int> cTongAffectedItem { get; set; }
        public Nullable<int> cTongWebsite { get; set; }
        public Nullable<int> cTongWebsiteScan { get; set; }
    }
}
